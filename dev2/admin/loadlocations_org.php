...
<tr valign="middle">
              ...
              <?php } ?>
              <?php if ($_GET['val'] == '2' || $_GET['val'] == '4' || $_GET['val'] == '6' || $_GET['val'] == '11') { ?>
               <tr valign="middle">
                <td align="right" height="30" width="30%" class="ob"><strong>Quick Grocery Stop:</strong></td>
                <td align="left" height="30" width="70%" class="ot2"><input name="store_stop" type="radio" value="No" checked="checked" /> <label><strong>No</strong></label>&nbsp;&nbsp;&nbsp;<input name="store_stop" type="radio" value="Yes" /> <label><strong>Yes</strong></label></td>
              </tr>
              <?php } ?>

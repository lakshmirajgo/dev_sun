...
$message .= $email_view['email_content'];
	...
	$message .='Again, we thank you for your business and look forward to seeing you on '.format_to_caldate($reservation_details[0]['pickup_date']).' at '.format_time($reservation_details[0]['pickup_time']).' time in Orlando, Florida!!<p><em>Sincerely,</em><br /><strong>Sun State Transportations</strong><br><br>

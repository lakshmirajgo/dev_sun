...
if (!chech_permissions($_SESSION['user_details'], 'price_sog')) {
...
//Check permissions for User END
	...
	if ($_GET['cAction'] == 'edit'){
		$price_view = get_current_prices_sog_view($_GET['id']);
		
		if ($_POST['action'] == 'edit') {
			if (edit_prices_sog($_GET['id'])) {
	...
	$delete_id[]=$_GET['id'];
	if(delete_prices_sog($delete_id))
		echo '<script language="javascript">alert(\'Price Deleted Successfully\');window.location=\'price_manager_sog.php\';</script>';
	else
		echo '<script language="javascript">alert(\'There was an error deleting the price\n\nPlease try again\');window.location=\'price_manager_sog.php\';</script>';
		$all_prices = get_all_prices_sog($_POST['vehicle_id'], $_POST['where']);
	}
	
	if (!empty($_POST['delete_selected'])){
		if(delete_prices_sog($_POST['id']))
...
function updatepage(str){
          ...
          <tr>
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30" width="62%" class="ot2">$<input name="total_amount" id="total_amount" class="bodytxt" size="12" type="text" style="color:#FF0000;"> </td>
              </tr>
              <tr>
	 ...
	 <table border="0" cellpadding="0" cellspacing="0" width="100%" class="ot">
      <tbody><tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <td class="bodytxt" align="center" height="48" valign="middle" background="images/top_center_curve.jpg"><strong>&nbsp;&nbsp;&nbsp;</strong>
              <table border="0" cellpadding="0" cellspacing="0" width="90%">
                <tbody><tr>
                  ...
                  <form name="search" method="post" action="price_manager_sog.php" style="padding:0px; margin:0px;">
				...
				?>
                  ...
                  <td style="border-bottom: 1px solid rgb(220, 220, 220);" align="right" height="20" valign="top"><a href="price_manager_sog.php?cAction=create_new"><img src="images/add_price.jpg" border="0" type="image" alt="Add a New Price" title="Add a New Price"></a></td>
                </tr>
              </tbody></table>
              <strong> </strong></td>
          </tr>
          <tr>
          	<td>
            <form name="displayfrm" method="post" action="price_manager_sog.php">
			<input type="hidden" value="delete" name="cAction">
		<table width="970" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="bodytxt" style="margin-top: 10px;">
             <tr bgcolor="#646464" >
                      ...
                      <td width="300" align="left" height="22" style="font-weight: bold; color:#FFFFFF" class="ot1">From</td>
                      <td width="300" align="left" height="22" style="font-weight: bold; color:#FFFFFF" class="ot1">To</td>
                      <td width="100" align="center" height="22" style="font-weight: bold; color:#FFFFFF" class="ot1">One Way Price</td>
                      <td width="120" align="center" height="22" style="font-weight: bold; color:#FFFFFF" class="ot1">Round Trip Price</td>
                      <td width="22"></td>
                      <td width="5"></td>
                  </tr>
                  <?php 	
					...
					?>
                      ...
                      <td width="300" align="left" class="ot1"><strong><a href="?cAction=edit&id=<?php echo $value['id']; ?>" class="bodytxt" title="Edit Page"><?php $location_from = get_locations_view($value['location1_id']); echo $location_from['name']; ?></a></strong></td>
                      <td width="300" align="left" class="ot1"><strong><a href="?cAction=edit&id=<?php echo $value['id']; ?>" class="bodytxt" title="Edit Page"><?php $location_to = get_locations_view($value['location2_id']); echo $location_to['name']; ?></a></strong></td>                      
                      <td width="100" height="22" align="center">$<?php echo sprintf("%01.2f", $value['oneway_price']); ?></td>
                      <td width="120" height="22" align="center">$<?php echo sprintf("%01.2f", $value['roundtrip_price']); ?></td>
                    ...
                    <? } 
						...
						} else { echo '</table><div align="center" style="padding-top:20px; padding-bottom:20px;"><strong>There are no prices in the database. <a href="price_manager_sog.php?cAction=create_new" class="link1">Create a new price</a></strong></div><table><tr><td></td></tr>'; } 
					?> 
					<tr>
	...
	?>
	<form id="create_new" style="padding-bottom:0px;" name="create_new" method="post" action="price_manager_sog.php" onsubmit="return validate(this)">
	<input name="action" type="hidden" value="create_new">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="ot">
      <tbody><tr>
        <td align="left" valign="top" width="11" height="100%">
          ...
          <tr>
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><select name="from" id="from" required="yes" size="1">
                                      <option value="" selected="selected"> -- Select One -- </option>
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><select name="to" id="to" required="yes" size="1">
                                      <option value="" selected="selected"> -- Select One -- </option>
              ...
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>One Way Price</strong></td>
                <td align="left" height="30" width="62%" class="ot2">$<input name="oneway_price" class="bodytxt" size="12" type="text"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>Round Trip Price</strong></td>
                <td align="left" height="30" width="62%" class="ot2">$<input name="roundtrip_price" class="bodytxt" size="12" type="text"></td>
              </tr>
              <tr>
                <td align="left" height="48" valign="middle" background="images/bottom_center_curve.jpg">&nbsp;</td>
	...
	if ($_GET[cAction] == 'edit') {
	?>
	<form id="edit_price" style="padding-bottom:0px;" name="edit_price" method="post" action="price_manager_sog.php?cAction=edit&id=<?php echo $_GET['id']; ?>" onsubmit="return validate(this)">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr valign="middle">
                <td align="right" height="20" width="38%" class="ob"><strong>From:</strong></td>
                <td align="left" height="20" width="62%" class="ot2"><?php $location_from = get_locations_view($price_view['location1_id']);?><select name="from" id="from" required="yes" size="1">
                                      <option value="<?php echo $price_view['location1_id']; ?>"><?php echo $location_from['name']; ?></option>
              ...
              <tr valign="middle">
                <td align="right" height="20" width="38%" class="ob"><strong>To:</strong></td>
                <td align="left" height="20" width="62%" class="ot2"><?php $location_to = get_locations_view($price_view['location2_id']);?><select name="to" id="to" required="yes" size="1">
                <option value="<?php echo $price_view['location2_id']; ?>"><?php echo $location_to['name']; ?></option>
              ...
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>One Way Price</strong></td>
                <td align="left" height="30" width="62%" class="ot2">$<input name="oneway_price" class="bodytxt" size="12" type="text" value="<?php echo $price_view['oneway_price']; ?>"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>Round Trip Price</strong></td>
                <td align="left" height="30" width="62%" class="ot2">$<input name="roundtrip_price" class="bodytxt" size="12" type="text" value="<?php echo $price_view['roundtrip_price']; ?>"></td>
              </tr>
              <tr>
                <td align="left" height="48" valign="middle" background="images/bottom_center_curve.jpg">&nbsp;</td>

...
//echo $_SESSION['redirect'] = $_SERVER['HTTP_REFERER'];
...
if (!chech_permissions($_SESSION['user_details'], 'settings')) {
...
?>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>Drivers Daily Wage Minimum Transfers:</strong></td>
                <td align="left" height="30" width="62%" class="ot2"><input name="driver_minimum_transfers" class="bodytxt" size="10" type="text" value="<?php echo $company_info['driver_minimum_transfers']; ?>"></td>
              </tr>
              <tr>
    ...
    <?php 
	//Hide this form for Users. Allow for Admin BEGIN
	...
	//Hide this form for Users. Allow for Admin END
	?>
    </div>
<?php

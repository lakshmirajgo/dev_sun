<?php
	...
	global $db;
		$edit_statuses_sql = "UPDATE statuses SET name='".$_POST['name']."', description='".$_POST['description']."', icon_id='".$_POST['icon_id']."' where id='$id'";
	...
	global $db; 
		$add_statuses_sql = "INSERT INTO statuses (name, description, icon_id) values('".$_POST['name']."', '".$_POST['description']."', '".$_POST['icon_id']."')";

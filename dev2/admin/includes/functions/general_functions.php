<?php
	...
	global $db;
		$edit_settings_sql = "UPDATE settings SET company='".
        mysql_real_escape_string($_POST['company'])."', address='".
        ...
        mysql_real_escape_string($_POST['country'])."', tollfree='".
        mysql_real_escape_string($_POST['tollfree'])."', telephone='".
        mysql_real_escape_string($_POST['telephone'])."', fax='".
        mysql_real_escape_string($_POST['fax'])."', email='".
        mysql_real_escape_string($_POST['email'])."', slogan='".
        mysql_real_escape_string($_POST['slogan'])."', home_page_title='".
        mysql_real_escape_string($_POST['home_page_title'])."', show_contact='".
        mysql_real_escape_string($_POST['show_contact'])."', show_map='".
        mysql_real_escape_string($_POST['show_map'])."', map_engine='".
        mysql_real_escape_string($_POST['map_engine'])."', minimum_time='".
        mysql_real_escape_string($_POST['minimum_time'])."', driver_minimum_transfers='".
        mysql_real_escape_string($_POST['driver_minimum_transfers'])."'";
	...
	function chech_permissions($user_details, $page_name){
		...
		if (empty($user_details) || $_SERVER['REMOTE_ADDR'] == '97.68.74.30') {

<?php
	...
	$client_id = $_POST['client_id'];
		...
		//$from[$count] = get_locations_view($_POST['from'.$count.'']);
		//$to[$count] = get_locations_view($_POST['from'.$count.'']);
		...
		//$edit_reservation_details_sql = "UPDATE reservation_details SET `from`='".$_POST['from'.$count.'']."', `to`='".$_POST['to'.$count.'']."', time='".$time[$count]."', pickup_time='".$time_admin[$count]."', pickup_date='".$date_admin[$count]."', airline='".$_POST['airline'.$count.'']."', flight_number='".$_POST['flight_number'.$count.'']."', date='".$date[$count]."' WHERE id ='".$_POST['details_id'.$count.'']."'";

...
function get_auth($data_array) {
	...
	return "Please provide a valid amount for credit card processing.";
	}

    if(empty($data_array['credit_card_number'])) {
    //echo "Please provide a valid Credit Card Number.<br><br>";
	return "Please provide a valid Credit Card Number.";
    }

    if(empty($data_array['credit_card_exp_date'])) {
    //echo "Please provide a valid Credit Card Expiration Date.<br><br>";
	return "Please provide a valid Credit Card Expiration Date.";
    }
   ...
   // if(empty($data_array['credit_card_cvv'])) {
    ...
    //echo "Please provide the Billing First Name.<br><br>";
	return "Please provide the Billing First Name.";
    }

    if(empty($data_array['billing_last'])) {
    //echo "Please provide the Billing Last Name.<br><br>";
	return "Please provide the Billing Last Name.";
    }

    if(empty($data_array['billing_city'])) {
    //echo "Please provide the Billing City.<br><br>";
    return "Please provide the Billing City.";
	}

    if(empty($data_array['billing_state'])) {
    //echo "Please provide the Billing State.<br><br>";
    return "Please provide the Billing State.";
	}

...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                <td align="right" height="20" width="38%" class="ob"><strong>Airline:</strong></td>
                <td align="left" height="20" width="62%" class="ot2"><select name="airline0" size="1">
                <optgroup label="Orlando Airport">
                ...
                <optgroup label="Sanford Airport">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><input name="flight_number0" class="bodytxt" size="10" type="text"></td>
              </tr>
</table>
<?php
}

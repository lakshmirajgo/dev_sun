...
if (!chech_permissions($_SESSION['user_details'], 'pages')) {
             ...
             <tr bgcolor="#646464" >
                  ...
                  <?php 	
					...
					?>
                      ...
                      <td width="484" align="left" class="ot1"><a href="?cAction=edit&id=<?php echo $value['id']; ?>" class="bodytxt" title="Edit Page"><?php echo str_replace("_", " ", ucfirst($value['page_name'])); ?></a></td>                      <td width="22" height="22" align="center"><a href="?cAction=delete&id=<?php echo $value['id']; ?>" class="bodytxt" title="Click to Delete"><img src="images/remove.png" border="0" onclick="return confirm('Are you sure you want to delete this page?\n\nNotice: deleted page cannot be restored')" /></a></td> 
                      <td width="5"></td>
                    </tr>
                    <? } 

...
if(isset($_GET['userid'])){
    ...
    <tr>
        ...
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t1= $today['0'].'-'.$d_monthname_previous_num.'-01'; $to_t1=$today['0'].'-'.$d_monthname_previous_num.'-31'; $total_t1 = get_reservations_reports($from_t1, $to_t1); echo count($total_t1); ?></td>
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t1_pr= $prev_year.'-'.$d_monthname_previous_num.'-01'; $to_t1_pr=$prev_year.'-'.$d_monthname_previous_num.'-31'; $total_t1_pr = get_reservations_reports($from_t1_pr, $to_t1_pr); echo count($total_t1_pr); ?></td>
    </tr>
    <tr>
        ...
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t2= $today['0'].'-'.$d_monthname_previous_num.'-01'; $to_t2=$today['0'].'-'.$d_monthname_previous_num.'-31'; $total_t2 = get_reservations_reports($from_t2, $to_t2); echo count($total_t2); ?></td>
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t2_pr= $prev_year.'-'.$d_monthname_previous_num.'-01'; $to_t2_pr=$prev_year.'-'.$d_monthname_previous_num.'-31'; $total_t2_pr = get_reservations_reports($from_t2_pr, $to_t2_pr); echo count($total_t2_pr); ?></td>
    </tr>
    <tr>
        ...
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t3= $today['0'].'-'.$d_monthname_previous_num.'-01'; $to_t3=$today['0'].'-'.$d_monthname_previous_num.'-31'; $total_t3 = get_reservations_reports($from_t3, $to_t3); echo count($total_t3); ?></td>
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t3_pr= $prev_year.'-'.$d_monthname_previous_num.'-01'; $to_t3_pr=$prev_year.'-'.$d_monthname_previous_num.'-31'; $total_t3_pr = get_reservations_reports($from_t3_pr, $to_t3_pr); echo count($total_t3_pr); ?></td>
    </tr>
    <tr>
        ...
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t4= $today['0'].'-'.$d_monthname_previous_num.'-01'; $to_t4=$today['0'].'-'.$d_monthname_previous_num.'-31'; $total_t4 = get_reservations_reports($from_t4, $to_t4); echo count($total_t4); ?></td>
        <td width="33%" height="20" valign="middle" align="center"><?php $from_t4_pr= $prev_year.'-'.$d_monthname_previous_num.'-01'; $to_t4_pr=$prev_year.'-'.$d_monthname_previous_num.'-31'; $total_t4_pr = get_reservations_reports($from_t4_pr, $to_t4_pr); echo count($total_t4_pr); ?></td>
    </tr>
    <tr>
   	  <td width="34%" height="20" valign="middle" style="padding-left:10px;" bgcolor="e4e4e4"><strong>Total Transfers</strong></td>
        <td width="33%" height="20" valign="middle" align="center" bgcolor="e4e4e4"><strong><?php $from_t= $today['0'].'-01-01'; $to_t=$today['0'].'-12-31'; $total_t = get_reservations_reports($from_t, $to_t); echo count($total_t); ?></strong></td>
        <td width="33%" height="20" valign="middle" align="center" bgcolor="e4e4e4"><strong><?php $from_t_pr= $prev_year.'-01-01'; $to_t_pr=$prev_year.'-12-31'; $total_t_pr = get_reservations_reports($from_t_pr, $to_t_pr); echo count($total_t_pr); ?></strong></td>
    </tr>
    </table>
    <br />
...
document.getElementById('myLocationdetailsto2').innerHTML = http.responseText;
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30"><input name="phone_number" class="bodytxt" size="20" id="phone_number" type="text" value="<?php echo $_SESSION['phone_number']; ?>"></td>
              </tr>
              <tr valign="middle">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30" width="100%" class="ot2"><!-- <div id="result"></div><br /> -->$<input name="total_amount" id="total_amount" class="bodytxt" size="12" type="text"><input value="Calculate Total" type="button" onclick='JavaScript:xmlhttpPost("calculate_sog.php")'>  </td>
  			  </tr>
              <tr valign="middle">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30" width="100%" class="ot2"><input name="card_number" class="bodytxt" size="32" type="text"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" width="100%" class="ob"><strong>Expiration Date</strong></td>
                <td align="left" height="30" width="100%" class="ot2"><select id="ExpMonth" name="ExpMonth" size="1">
      ...
      <tbody><tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><?php echo $from[$count]['name']; ?><input name="from<?php echo $count; ?>" type="hidden" value="<?php echo $reservation_details[$count]['from']; ?>" /></td>
              </tr>
              <tr valign="middle">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><?php echo $to[$count]['name']; ?><input name="to<?php echo $count; ?>" type="hidden" value="<?php echo $reservation_details[$count]['to']; ?>" /></td>
              </tr>
          </table>
          </td>
          </tr>
		  ...
		  //Number of legs -> make a loop END
              ...
              <tr valign="middle">
                <td align="right" height="30" class="ob"><strong>Phone Number</strong></td>
                <td align="left" height="30"><input name="phone_number" class="bodytxt" size="39" id="phone_number" type="text" value="<?php echo $reservation_view['phone_number']; ?>"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" class="ob"><strong>Mobile Phone</strong></td>

...
<script language="javascript">
	...
	function assign_driver(resId, resDetailsId, driversId, notifyDriver){
		...
		window.open(url,'Assign Drivers','height=200,width=300');
		return false;
	}
...
<!--	 <table border="0" cellpadding="0" cellspacing="0" width="100%" class="ot">
    ...
    <tr>
                ...
                From <input name="from" type="text" id="from" size="8" maxlength="10" value="<?php if (!empty($_POST['from'])) echo $_POST['from']; else { echo date("m/d/Y");}?>">&nbsp;<img src="img/cal.gif" width="16" height="16" onclick="displayDatePicker('from');"><i> <font color="#ff0000" size=2>select date</font></i>
                </td>
                <td>
                To &nbsp;&nbsp;&nbsp;&nbsp;<input name="to" type="text" id="to" size="8" maxlength="10" value="<?php if (!empty($_POST['to'])) echo $_POST['to']; else { echo date("m/d/Y");}?>">&nbsp;<img src="img/cal.gif" width="16" height="16" onclick="displayDatePicker('to');"><i> <font color="#ff0000" size=2>select date</font></i></td>
            </tr>
            <tr>
                <td style="padding:5px;">
                </td>

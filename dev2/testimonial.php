...
include ("includes/functions/testimonials_functions.php");
$all_vehicles = get_all_vehicles();
$page = get_pages_view('testimonials');
$company_info = get_company_info(); 
$testimony=get_all_testimonials();
?>
...
<body onload="MM_preloadImages('images/fleet_active.gif','images/faq_active.gif','images/reserve_active.gif','images/contact_active.gif','images/home_active.gif','images/rates_active.gif')">
<div id="Wrapper"> 
 <!--Start Header Here -->
    	<div id="Header">
        ...
        <div id="Navigation">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><a href="faq.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','images/faq_active.gif',1)"><img src="images/faq_normal.gif" name="Image15" width="81" height="33" border="0" id="Image15" /></a></td>
                <td><img src="images/testimonials_active.gif" width="139" height="33" /></td>
...
<area shape="rect" coords="4,243,172,268" href="reserve.php" />
    ...
    <div id="RightColumn"> 
    		<h1><strong><a href="#" name="TOP" id="TOP"></a>SunState Transportation - Testimonials</strong></h1>
			...
			<?php
				...
				?>
					<tr>
						<td>&nbsp;</td>
						<td class="testimonialsBG"><strong>No Testimonials found</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
				...
				{
					for($x=0;$x<sizeof($testimony);$x++)
					{
					?>
						<tr>
							<td>&nbsp;</td>
							<td class="testimonialsBG">
								<?php echo $testimony[$x]['testimonial'];echo " ".date('F d, Y', strtotime($testimony[$x]['date_submitted'])); ?>
								<br />
								<strong><?php echo $testimony[$x]['name'];echo(!empty($testimony[$x]['city']))?' - '.$testimony[$x]['city']:'';echo (!empty($testimony[$x]['state']))?' '.$testimony[$x]['state']:'';?></strong>
							</td>
						</tr>
					<?php
						if($x!=sizeof($testimony)-1)
						{
						?>
							<tr>
								<td>&nbsp;</td>
            ...
            <br />
              <div align="center">
                <a href="testimonials_form.php" class="lbOn"><img src="images/submit_a_testimony.png" border="0" alt="Submit a testimony" title="Submit a testimony"></a>
                </div>
                <br />
      </div>

...
<td style="padding:5px;">
                From <input name="from" type="text" id="from" size="8" maxlength="10">&nbsp;<img src="img/cal.gif" width="16" height="16" onClick="javascript:cal1.popup();"><i> <font color="#ff0000" size=2>select date</font></i>                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            	<td style="padding:5px;">&nbsp;</td>
              <td style="padding:5px;">
                ...
                <td style="padding:5px;"><input name="calculate_total" type="submit" value="Get Report">                </td>
            </tr>
        </table>
    </form>

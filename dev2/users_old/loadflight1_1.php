...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><select name="airline1" size="1">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><input name="flight_number1" class="bodytxt" size="10" type="text"></td>
              </tr>
</table>
<?php
}

<?php
	...
	$signup_date = date('Y-m-j, h-i-s');
		$add_clients_sql = "INSERT INTO clients  (first_name, last_name, address, address2, city, state, zip, country, telephone, telephone2, cellphone, fax, email, username, password, signup_date) values('".$_POST['first_name']."', '".$_POST['last_name']."', '".$_POST['address']."', '".$_POST['address2']."', '".$_POST['city']."', '".$_POST['state']."', '".$_POST['zip']."', '".$_POST['country']."', '".$_POST['phone_number']."', '".$_POST['telephone2']."', '".$_POST['cellphone']."', '".$_POST['fax']."', '".$_POST['email']."', '".$_POST['username']."', '".md5($_POST['password_new'])."', '$signup_date')";
	...
	global $db; 
	$signup_date = date('Y-m-j, h-i-s');
		$add_clients_sql = "INSERT INTO clients  (first_name, last_name, address, address2, city, state, zip, country, telephone, telephone2, cellphone, fax, email, username, password, signup_date) values('".$_POST['first_name']."', '".$_POST['last_name']."', '".$_POST['address']."', '".$_POST['address2']."', '".$_POST['town']."', '".$_POST['state']."', '".$_POST['zip']."', '".$_POST['country']."', '".$_POST['telephone']."', '".$_POST['telephone2']."', '".$_POST['cellphone']."', '".$_POST['fax']."', '".$_POST['email']."', '".$_POST['username']."', '".md5($_POST['password_new'])."', '$signup_date')";

<?php
	...
	global $db;
		$edit_locations_sql = "UPDATE locations SET zone_id='".$_POST['zone_id']."', location_type='".$_POST['location_type']."', name='".$_POST['name']."', address='".$_POST['address']."', city='".$_POST['town']."', state='".$_POST['state']."', zip='".$_POST['zip']."', phone='".$_POST['phone']."' where id='$id'";
	...
	global $db; 
		$add_locations_sql = "INSERT INTO locations  (zone_id, location_type, name, address, city, state, zip, phone) values('".$_POST['zone_id']."', '".$_POST['location_type']."', '".$_POST['name']."', '".$_POST['address']."', '".$_POST['town']."', '".$_POST['state']."', '".$_POST['zip']."', '".$_POST['phone']."')";

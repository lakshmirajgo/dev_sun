<?php
	...
	global $db;
		$edit_prices_sql = "UPDATE prices SET price_value='".$_POST['price_value']."', vehicle_id='".$_POST['vehicle_id']."', location1_id='".$_POST['from']."', location2_id='".$_POST['to']."', custom_bundle='".$_POST['custom_bundle']."' where id='$id'";

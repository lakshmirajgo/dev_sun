<?php
	...
	$email_content2 = str_replace("../", "http://www.sunstatelimo.com/", $_POST['email_content2']);
		...
		$edit_emails_sql = "UPDATE email_templates SET status_id='".$_POST['status_id']."', email_name='".$_POST['email_name']."', email_title='".$_POST['email_title']."', email_content='".$email_content."', email_content2='".$email_content2."' where id='$id'";
	...
	$email_content2 = str_replace("../", "http://www.sunstatelimo.com/", $_POST['email_content2']);
		...
		$add_emails_sql = "INSERT INTO email_templates  (status_id, email_name, email_title, email_content, email_content2) values('".$_POST['status_id']."', '".$_POST['email_name']."', '".$_POST['email_title']."', '".$email_content."', '".$email_content2."')";

...
<?php
if ($_SERVER['PHP_SELF'] == "/users/vehicle_manager.php") {
?>
<!-- TinyMCE -->
...
if ($_SERVER['PHP_SELF'] == "/users/page_manager.php" || $_SERVER['PHP_SELF'] == "/users/email_manager.php") {
?> 
<!-- TinyMCE -->
<script type="text/javascript" src="js/tiny_mce/tiny_mce.js"></script>
<script type="text/javascript">
...
<?php
if ($_SERVER['PHP_SELF'] == "/users/reservation_manager.php" || $_SERVER['PHP_SELF'] == "/users/index.php" || $_SERVER['PHP_SELF'] == "/users/index_search.php" || $_SERVER['PHP_SELF'] == "/users/report_manager.php" || $_SERVER['PHP_SELF'] == "/users/get_report.php") {
?>
...
?>
<?php
if ($_SERVER['PHP_SELF'] == "/users/index.php") {
?>

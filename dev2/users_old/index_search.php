...
<div align="center">
    ...
    <form name="report" method="post" action="index_search.php" style="padding:0px; margin:0px;">
    <table width="500" cellpadding="0" cellspacing="0" border="0" style="border:#999999 solid 1px;" bgcolor="#e4e4e4">
    <tr>
    	<td colspan="2" align="center" valign="middle"><h3>Search <?php if (!empty($_GET['from'])) { echo $_GET['from'];}; if (!empty($_GET['to'])) { echo ' - '.$_GET['to']; }; ?></h3></td>
    </tr>
    <tr>

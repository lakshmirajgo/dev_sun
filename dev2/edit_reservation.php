...
exit(); 
	...
	/* DISABLE PAYMENT INFORMATION UPDATE - 2013.10.18 */
	/*
          ...
          <tr>
           ...
           <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                <td align="left" height="30" width="100%" colspan="2" class="ob" style="padding: 25px;color: #F00;background: #FFF;font-size: 13pt;">Notice: Your reservation is within 48hrs. In order to request any changes please call <?php echo $company_info['company'];?> right away at <?php echo $company_info['telephone'];?>. Also be sure to review our reservation change policy on the reservation confirmation email we sent on <?php echo date('m/d/Y', strtotime($reservation_view['reservation_date']));?>.</td>
              </tr>
            </table>
            <?php
            }
...
<?php /* DISABLE PAYMENT INFORMATION UPDATE - 2013.10.18 *//* 
           <form id="edit_reservation" style="padding-bottom:0px;" name="edit_reservation" method="post" action="edit_reservation.php?cAction=edit&id=<?php echo $_GET['id']; ?>" onsubmit="return validate(this)">
...
*/ ?>
           <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30" width="62%" class="ot2">
                	<?php echo $reservation_view['card_type']; ?>
<?php /* DISABLE PAYMENT INFORMATION UPDATE - 2013.10.18 *//*
...
*/ ?>
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30" width="62%" class="ot2">
                	<?php echo "************". substr($reservation_view['card_number'],12, 4);?>
<?php /* DISABLE PAYMENT INFORMATION UPDATE - 2013.10.18 *//*
                <input name="card_number" class="bodytxt" size="32" type="text" value="<?php echo "************". substr($reservation_view['card_number'],12, 4);?>">
*/ ?>	
                </td>
              </tr>
              <tr valign="middle">
...
<?php /* DISABLE PAYMENT INFORMATION UPDATE - 2013.10.18 *//*
                    ...
                    if( $i == $exp_date[1] ) $selected='selected="selected"';
                    else $selected='';
...
*/ ?>
              ...
              <tr>
              	<td width="100%" colspan="2"><div style="background-color:#efefef; padding:5px; border:#CCCCCC solid 1px;"><span style="color:#000000;"><input name="paying_cash" value="Yes" id="paying_cash" type="checkbox" <?php if ($reservation_view['paying_cash'] == 'Yes') { ?> checked="checked" <?php } ?> disabled="disabled"> Please do not charge my credit card. I will be paying cash or traveler check upon arrival I understand I am submitting my credit card info only to guarantee my reservation. I also read and understand Sunstate Transportation cancellation policy.</span></div>      
                </td>
              </tr>
<?php /* DISABLE PAYMENT INFORMATION UPDATE - 2013.10.18 *//*
              <tr valign="middle">
...
*/ ?>
           <?php /** DISABLED AS PER RASH INSTRUCTIONS ON 10/15/14 - MARTIN
           <form id="edit_reservation" style="padding-bottom:0px;" name="edit_reservation" method="post" action="edit_reservation.php?cAction=edit&id=<?php echo $_GET['id']; ?>" onsubmit="return validate(this)">
	<input name="action" type="hidden" value="reservation_info">
            ...
            **/
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                <td align="left" height="30" width="30%" class="ob"><strong>Customer Comments:</strong></td>
                <td align="left" height="30" class="ot2"><?php echo $reservation_view['customer_comments']; ?></td>
              </tr>
            </table>
          </td>
          <td width="11" height="11">&nbsp;</td>

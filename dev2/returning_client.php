...
<title>Orlando's Airport Premier Transportation Services - Login</title>
...
<br />
<!--
<form style="padding-bottom:0px;" name="login" method="post" action="login.php<?php if (!empty($_GET['redirect'])) { echo "?redirect=".$_GET['redirect']; }; ?>" onsubmit="return validate(this)">-->
<form style="padding-bottom:0px;" name="login" method="post" action="login.php<?php if (!empty($_GET['redirect'])) { echo "?redirect=".$_GET['redirect']; }; ?>" >
    ...
    <div align="center">
    <a href="new_client.php">Create a new account</a> | <a href="forgot_password.php">Forgot password?</a>
    </div>
    </form>
           <br />
    </div>

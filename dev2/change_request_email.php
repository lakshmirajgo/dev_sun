...
' . $message.'<br>Below are is the current reservation detail. To edit this reservation <a href="http://www.sunstatelimo.com/admin/reservation_manager.php?cAction=edit&id='.$_GET['id'].'" target="_blank">click here</a>' . $message_sunstate;
	...
	$_SESSION['notice'] = '<div style="background-color:#d1fac3; padding:5px; border:#72da4e solid 1px; width:700px;" align="left">Thank you for the updates. We\'ll update your reservation and resend you a new confirmation with in 24hrs you can also log back to your reservation to verify your request has been met. If your schedule transportation is to take place within 48hrs, we recommend you call Sunstate at 407-601-7900.<br><br>
<em>Sincerely,<br>

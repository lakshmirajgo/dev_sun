...
<body onload="MM_preloadImages('images/fleet_active.gif','images/faq_active.gif','images/reserve_active.gif','images/home_active.gif','images/rates_active.gif','images/testimonials_active.gif')">
<div id="Wrapper"> 
 <!--Start Header Here -->
    	<div id="Header">
        ...
        <div id="Navigation">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><a href="testimonial.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image20','','images/testimonials_active.gif',1)"><img src="images/testimonials_normal.gif" name="Image20" width="139" height="33" border="0" id="Image20" /></a></td>
                ...
                <td><img src="images/contact_active.gif" width="116" height="33" /></td>
              </tr>
            </table>
        </div>
<!--End Navigation Here --> 
<div id="Banner"> 
<img src="images/<?php echo $img_head;?>" width="738" /><br />
</div>

...
if ($_SESSION['num_legs'] != '3') {
				...
				if (typeof document.getElementById("from") != \'null\') {
					document.getElementById("from").value ='  .print $_SESSION['from'];.';}
				if (typeof document.getElementById("to") != \'null\') {
					document.getElementById("to").value =' .print $_SESSION['to'].';}';
				
				$trip_type = 'getNewContent('.print $_SESSION['trip_type'];.');
								if (typeof document.getElementById("Select1") != \'null\') {
									document.getElementById("Select1").value ='.print $_SESSION['trip_type'];.';}'
				
				
				};
				
if ($_SESSION['num_legs'] == '3') {
		$trip_details = 'if (typeof document.getElementById("location1") != \'null\') {
			document.getElementById("location1").value = ' .print $_SESSION['location1'];.' ;};
		if (typeof document.getElementById("location2") != \'null\') {
					document.getElementById("location2").value =' .print $_SESSION['location2'];.';};	
		if (typeof document.getElementById("location3") != \'null\') {
					document.getElementById("location3").value = '.print $_SESSION['location3'];.';};
...
<!--<script language="JavaScript">
//this script coppies mailing address to billing address if billing address checkbox is filled
...
<!--login form-->
 <div id="pane01">
 	<div class="form">
		...
		<p><input name="email" type="text" value="Username" onfocus="clearText(this)" onblur="clearText(this)"/></p>
		<p><input name="password" type="text" value="Password" onfocus="clearText(this)" onblur="clearText(this)"/></p>
...
<div class="pass-left">
<p>First Name</p>
<p><input name="Client_first_name" type="text" value=" <?php echo $_SESSION['client_first_name']; ?> "/></p>

<p>Address</p>
<p><input name="client_address" type="text" value=" <?php echo $_SESSION['client_address']; ?> "/></p>


<p>Telephone</p>
<p><input name="Telephone" type="text" value=" <?php echo $_SESSION['client_telephone']; ?> "/></p>

<?php if ($_SESSION['auth'] != '1') {echo "<p>Create Password</p><p><input name=\"\" type=\"text\" /></p>";};?>
</div>
...
<p class="region">
<span><input name="Client_city" type="text" value=" <?php echo $_SESSION['client_city']; ?> "/></span>
<span><input name="Client_state" type="text" value=" <?php echo $_SESSION['client_state']; ?> "/></span>
<span><input name="Client_zip" type="text" value=" <?php echo $_SESSION['client_zip']; ?> "/></span>
</p>
...
<?php if ($_SESSION['auth'] != '1') {echo "<p>Confirm Password</p><p><input name=\"\" type=\"text\" /></p>";};?>

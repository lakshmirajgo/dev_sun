<?php
	...
	function reset_password($email){
		...
		//exit;
			...
			$message = "Your account password reset request has processed successfully. To login to your account please use your email address and the password below<br /><br />New Password: $newpassword<br /><br />If you have any questions or concerns please call us 1(407) 601-7900.\n\nThank you and have a nice day<br /><br /><a href=\"http://www.sunstatelimo.com\">Sun State Transportations<br />http://www.sunstatelimo.com</a>";

<?php
	...
	global $db;
		$edit_emails_sql = "UPDATE email_templates SET status_id='".$_POST['status_id']."', email_name='".$_POST['email_name']."', email_title='".$_POST['email_title']."', email_content='".$_POST['email_content']."' where id='$id'";
	...
	function add_emails(){
	global $db; 
		$add_emails_sql = "INSERT INTO email_templates  (status_id, email_name, email_title, email_content) values('".$_POST['status_id']."', '".$_POST['email_name']."', '".$_POST['email_title']."', '".$_POST['email_content']."')";

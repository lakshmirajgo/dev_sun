...
exit(); 
	...
	header ("Location: print_reservation.php?id=".$_GET['id']."");
	// Quit the script
	exit(); 
	}
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" background="images/middle_part.jpg">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
              ...
              <tr valign="middle">
                ...
                <input name="date<?php echo $count; ?>" type="text" id="date<?php echo $count; ?>" size="10" maxlength="10" value="<?php echo format_to_caldate($reservation_details[$count]['date']);?>">&nbsp;<img src="img/cal.gif" width="16" height="16" onClick="javascript:cal<?php echo $count; ?>.popup();"><i> <font color="#ff0000" size="1">click to select date</font></i><br />
                MM/DD/YYYY
                <script language="JavaScript">
				var cal<?php echo $count; ?> = new calendar2(document.forms['reserve'].elements['date<?php echo $count; ?>']);
		  ...
		  //Number of legs -> make a loop END
              ...
              <tr valign="middle">
                ...
                <td align="right" height="30" width="62%" class="ot2">
                <input src="images/but_update.jpg" border="0" type="image" onclick="if (validateDate(reserve.date0.value, valDateFmt(reserve.datefmt),valDateRng(reserve.daterng))) {} else {alert('You can only reserve online if your arrival is <?php echo $company_info['minimum_time']*24; ?>hrs prior.\n\nPlease call 407-601-7900 to reserve over the phone'); return false;}; if (validateDate(reserve.date1.value, valDateFmt(reserve.datefmt),valDateRng(reserve.daterng))) {} else {alert('You can only reserve online if your arrival is <?php echo $company_info['minimum_time']*24; ?>hrs prior.\n\nPlease call 407-601-7900 to reserve over the phone'); return false;}; if (validateDate(reserve.date2.value, valDateFmt(reserve.datefmt),valDateRng(reserve.daterng))) {} else {alert('You can only reserve online if your arrival is <?php echo $company_info['minimum_time']*24; ?>hrs prior.\n\nPlease call 407-601-7900 to reserve over the phone'); return false;}">
                </td>
              </tr>
           </tbody>
           </table>
	...
	<input name="action" type="hidden" value="passenger_info">
           <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30"><?php echo $reservation_view['email']; ?><input name="email" class="bodytxt" size="39" id="email" disabled="disabled" type="hidden" value="<?php echo $reservation_view['email']; ?>"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" class="ob"><strong>Phone Number: </strong></td>
                <td align="left" height="30"><input name="phone_number" class="bodytxt" size="20" id="phone_number" type="text" value="<?php echo $reservation_view['phone_number']; ?>"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" class="ob"><strong>Mobile Phone: </strong></td>
                <td align="left" height="30"><input name="cellphone" class="bodytxt" size="20" id="cellphone" type="text" value="<?php echo $reservation_view['cellphone']; ?>"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob">&nbsp;</td>

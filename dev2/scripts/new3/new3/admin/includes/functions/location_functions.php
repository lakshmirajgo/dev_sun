<?php
	...
	function get_all_airports(){
		global $db;
			$get_all_airports_sql = "SELECT * FROM airports ORDER BY name ASC";
	...
	function get_locations_view($id){
		global $db;
			$get_locations_view_sql = "SELECT * FROM hotels where id='$id'";
	...
	global $db;
		$edit_locations_sql = "UPDATE hotels SET zone_id='".$_POST['zone_id']."', code='".$_POST['code']."', name='".$_POST['name']."', address='".$_POST['address']."', city='".$_POST['town']."', state='".$_POST['state']."', zip='".$_POST['zip']."', phone='".$_POST['phone']."' where id='$id'";
	...
	global $db; 
		$add_locations_sql = "INSERT INTO hotels  (zone_id, code, name, address, city, state, zip, phone) values('".$_POST['zone_id']."', '".$_POST['code']."', '".$_POST['name']."', '".$_POST['address']."', '".$_POST['city']."', '".$_POST['state']."', '".$_POST['zip']."', '".$_POST['phone']."')";
	...
	function get_all_cruises(){
		global $db;
			$get_all_cruises_sql = "SELECT * FROM cruise_lines ORDER BY id ASC";
      ...
      <tbody><tr>
		...
		<table width="820" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="margin-top: 10px;" class="bodytxt" align="center">
             <tr bgcolor="#646464" >
                      ...
                      if ($_GET['sort'] == 'asc' || $_GET['sort'] == '') {
					  ?>
                      <a href="location_manager.php?orderby=zone&sort=desc" class="link2">Zone</a>
					  <?php } else { ?>
                      <a href="location_manager.php?orderby=zone&sort=asc" class="link2">Code</a>
					  <?php } ?>  
                      </td>

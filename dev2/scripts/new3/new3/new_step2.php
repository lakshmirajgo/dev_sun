		...
		<table>
			...
			<!--begin trip type dropdown-->
				<td>
					...
					<td>
						<div class="pass-right">
							<p>Passenger Count</p>
							<p><input name="" type="text" style="width: 25px;"value = <?php echo $_SESSION[passenger_count];?>></p>
						</div>
					</td>
				</tr>
			</table>
			...
			<p>
				<div class="example-container">
					<p>Date & Time</p>
					<div>
						<input type="text" value="<?php echo $_SESSION['travel_date']; ?>" id="basic_example_1" name="basic_example_1" class="hasDatepicker" >
					</div>					

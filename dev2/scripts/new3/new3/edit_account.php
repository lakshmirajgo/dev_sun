...
$client_view = get_client_view($_SESSION['email']);
		...
		//$client_view_by_id = get_client_view_by_id($client_view['id']);
			if (edit_clients($client_view['id']))
			$_SESSION['notice'] = '<div style="background-color:#d1fac3; padding:5px; border:#72da4e solid 1px; width:580px;" align="center">Account updated successfully</div>';
		else
			$_SESSION['notice'] = '<div style="background-color:#fce3e3; padding:5px; border:#FF0000 solid 1px; width:580px;" align="center"><span style="color:#FF0000;">Error updating account</span></div>';
			
			$client_view = get_client_view_by_id($client_view['id']);
		}
		
		if ($_POST['action2'] == 'update_password') {
		if(md5($_POST['password_old']) != $client_view['password']){
			$_SESSION['notice'] = '<div style="background-color:#fce3e3; padding:5px; border:#FF0000 solid 1px; width:580px;" align="center"><span style="color:#FF0000;">Sorry the old password entered does not match. Try again</span></div>';
		
		} else {
		if($_POST['password_new'] != $_POST['password_confirm']){
			$_SESSION['notice'] = '<div style="background-color:#fce3e3; padding:5px; border:#FF0000 solid 1px; width:580px;" align="center"><span style="color:#FF0000;">Sorry the new password entered does not match. Try again</span></div>';
		}
		else{	
			update_client_password($_POST['email'], $_POST['password_old'], $_POST['password_new'], $client_view['id']);
			$_SESSION['notice'] = '<div style="background-color:#d1fac3; padding:5px; border:#72da4e solid 1px; width:580px;" align="center">Your account password update request has processed successfully.</div>';
...
window.location = "https://www.sunstatelimo.com/edit_account.php";
}
-->
</script>
...
<div id="NormalText" class="NormalText"> 
          ...
          <form id="edit_client" style="padding-bottom:0px;" name="edit_client" method="post" action="edit_account.php?cAction=edit" onsubmit="return validate(this)">
          ...
          <tbody><tr>
            ...
            <td class="bodytxt" align="center" height="48" valign="middle" background="images/top_center_curve.jpg"><strong>&nbsp;&nbsp;&nbsp;</strong>
              <table border="0" cellpadding="0" cellspacing="0" width="90%">
                <tbody><tr>
                  <td style="border-bottom: 1px solid rgb(220, 220, 220);" align="left" height="20" valign="top"><strong>EDIT ACCOUNT</strong></td>
                </tr>
              </tbody></table>
              <strong> </strong></td>
    ...
    <form id="update_password" style="padding-bottom:0px;" name="update_password" method="post" action="edit_account.php?cAction=edit" onsubmit="return validate2(this)">
            ...
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody><tr valign="middle">
                ...
                <td align="left" height="30" width="62%">
                  <label>
                  <input name="email" class="bodytxt" size="39" id="username" type="text" disabled="disabled" value="<?php echo $client_view['email']; ?>">
                  </label>
                 </td>
              </tr>
              <tr valign="middle">
                <td height="30" align="right" class="ob"><strong>Old Password: <font color="#ff0000" size="2">*</font></strong></td>
                <td align="left" height="30"><input name="password_old" class="bodytxt" size="39" id="password_old" type="password"></td>
              </tr>
              <tr valign="middle">
                <td height="30" align="right" class="ob"><strong>New Password: <font color="#ff0000" size="2">*</font></strong></td>

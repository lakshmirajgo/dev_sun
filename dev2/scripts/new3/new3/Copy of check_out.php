        ...
        <tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr valign="middle">
                ...
                <td align="left" height="20" width="62%" class="ot2"><?php echo $_SESSION['store_stop']; ?> (Quick grocery/liquor store stop)<input name="store_stop" type="hidden" value="<?php echo $_SESSION['store_stop']; ?>" /></td>
              </tr>
              <?php } ?>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
           <tr>
              ...
              <tr valign="middle">
                ...
                <td align="left" height="30"><input name="email" class="bodytxt" size="39" id="email" type="text" value="<?php if(!empty($_SESSION['notice'])) { echo $_SESSION['email']; } else { echo $client_view['email']; };?>"></td>
              </tr>
              <tr>

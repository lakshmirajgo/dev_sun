...
$transfer['price_value'] = $transfer['price_value']*2;
};

//Custom Pricing for Orlando Airport to shades of green roundtrip

if(($_SESSION['from'] ==421 && $_SESSION['to']==517) || ($_SESSION['to'] ==421 && $_SESSION['from']==517)){
	if ($_SESSION['trip_type_new'] == '2') {
		if($_SESSION['vehicle']==1)
			$transfer['price_value'] =99;
		if($_SESSION['vehicle']==2)
			$transfer['price_value'] =125;
	}
}

...
<link href="new_step2_files/master.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="new_step2_files/jquery.js"></script>
<script type="text/javascript" src="new_step2_files/animatedcollapse.js"></script>
...
<script type="text/javascript" src="new_step2_files/jwplayer.html"></script>

<!-- End -->


<link rel="stylesheet" media="all" type="text/css" href="new_step2_files/jquery-ui.css">
		<link rel="stylesheet" media="all" type="text/css" href="new_step2_files/jquery-ui-timepicker-addon.css">
		
		<script src="new_step2_files/jquery_002.js" type="text/javascript" charset="utf-8"></script>
		
		<script type="text/javascript" src="new_step2_files/jquery-1.js"></script>
		<script type="text/javascript" src="new_step2_files/jquery-ui.js"></script>
		<script type="text/javascript" src="new_step2_files/jquery-ui-timepicker-addon.js"></script>
...
<div id="Header">
	...
	<tbody><tr>
		<td valign="middle" width="19%"><img alt="Sunstate" src="new_step2_files/sunstate.gif"></td>
		<td align="right" width="81%"><img usemap="#Map" src="new_step2_files/topRightCars.jpg" border="0" height="102" width="367"></td>
	</tr>
</tbody></table>		<!--
...
<div class="from-to">
<h3>Orlando Airport</h3>

<h4>Adventure Motel</h4>
</div>
...
<a href="#" rel="toggle[pane01]"></a>
 ...
 <div speed="400" fade="1" groupname="pets" style="display: none;" id="pane01">
 <div class="form">

<p><input name="" value="Username" onfocus="clearText(this)" onblur="clearText(this)" type="text"></p>

<p><input name="" value="Password" onfocus="clearText(this)" onblur="clearText(this)" type="text"></p>

<p><a href="#"><img src="new_step2_files/login-btn-2.png"></a></p>


<p style="float:right; margin:0 30px 0 0 "><a href="#" onclick="setVisibility();"><img src="new_step2_files/close.png"></a></p>
...
<div class="passenger">
<div class="pass-top"><img src="new_step2_files/pass-top.jpg"></div>
<div class="pass-mid">
...
<div class="pass-bott"><img src="new_step2_files/pass-bott.jpg" height="13" width="738"></div>
</div>
...
<div class="passenger">
<div class="pass-top"><img src="new_step2_files/transfer-top.jpg"></div>
...
</p><div class="example-container">
						<p>Date &amp; Time</p>
						<div>
					 		<input class="hasDatepicker" name="basic_example_1" id="basic_example_1" type="text">
						</div>					
<pre style="display:none">$('#basic_example_1').datetimepicker();
</pre>
					</div>
...
<div class="seat-sec">
<span>
<p><input name="" value="" type="checkbox"></p>
<p>Booster Seat </p>
<p><input name="" value="" type="checkbox"></p>
<p>Grocery Stop  </p>
<p><input name="" value="" type="checkbox"></p>
...
<div class="pass-bott"><img src="new_step2_files/transfer-bott.jpg" height="13" width="738"></div>
</div>
...
<div class="passenger">
<div class="pass-top"><img src="new_step2_files/payment-top.jpg"></div>
<div class="pmt-mid">
...
<h3>
<p>
<input name="" value="" style="width:20px; " type="checkbox">
</p>
...
<div class="pass-bott"><img src="new_step2_files/payment-bott.jpg" height="13" width="738"></div>
</div>
...
<div align="center"><input name="" class="btn" type="button"></div>

		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>Code</strong></td>
                <td align="left" height="30" width="62%" class="ot2"><input name="code" class="bodytxt" size="39" type="text"></td>
              </tr>
              <tr valign="middle">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="left" valign="top"><table class="bodytxt" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr valign="middle">
                <td align="right" height="30" width="38%" class="ob"><strong>Code</strong></td>
                <td align="left" height="30" width="62%" class="ot2"><input name="code" class="bodytxt" size="39" type="text" value="<?php echo $location_view['code']; ?>"></td>
              </tr>
              <tr valign="middle">
                <td align="right" height="30" class="ob"><strong>Name</strong></td>

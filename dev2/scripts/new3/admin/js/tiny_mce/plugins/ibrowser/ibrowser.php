        ...
        <div class="brdPad">
          <div id="mainDiv">
            ...
            <div id="imDiv" class="showit">
              <p><img src="http://www.imperialwebsolutions.net/images/sm_logo.gif" alt="IWS Site Manager" width="80" height="25"> <span class="style1">Imperial
                Web Solutions Site Manager</span></p>
              <p>Image browser can be used to easily upload and manipulate images
                on your website.</p>
              <p><strong>Features</strong>:</strong> upload images, automatically
                resize them and also rename your image files.<br>
                <strong>Usage: </strong>To
                insert or upload images to your content, click
                on the insert button on the left and select an image to insert. To insert an image as a popup,
                click on the Popup icon. If you want to specify image properties
                such as width, height and spacing click select an image then
                click on properties. Once you are done, click the Insert button
                at the bottom. <br>
                <strong>Uploading Images :</strong> Click on the insert icon
                on the left, then click <img src="images/upimg.gif" alt="upload" width="16" height="16" border="0"> (image
                upload icon) then select the file from your computer, click
                open and then click  <img src="images/okclick.gif" alt="okupload" width="16" height="16"> (upload
                icon) to upload the image. The image is now available in the
                select area with the rest of your images. </p>
              <p><strong>Tip:</strong> To make managing your pictures easy, rename
                the images to something easy to understand.              </p>
              <div class="btnRight">

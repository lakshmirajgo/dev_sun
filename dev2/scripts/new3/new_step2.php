...
if ($_SESSION['num_legs'] != '3') {
				$trip_details = 'if (typeof document.getElementById("from") != \'null\') {
				...
				$trip_type = 'getNewContent ('.$_SESSION['trip_type'].', '.<php print $_SESSION['from'].');
								if (typeof document.getElementById("Select1") != \'null\') {
									document.getElementById("Select1").value ='.$_SESSION['trip_type'].';';

...
<!--	<tr>
		<td>											
			Date & Time<br>
			<input type="text" name="from_date" id="basic_example_1" style="width: 140px;" value="<?php echo $_SESSION['travel_date']; ?>" />
		...
		<td>											
			Date & Time<br>
			<input type="text" name="to" id="basic_example_1" style="width: 140px;" value="<?php echo $_SESSION['travel_date']; ?>" />
			<pre style="display:none">
				$('#basic_example_3').datetimepicker();
			</pre>
		</td>	

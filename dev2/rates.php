...
$page = get_pages_view('rates');
$page_banner = get_pages_view('specials_banner');
$page_bottom = get_pages_view('rates_bottom');
$page_bottom2 = get_pages_view('quote_bottom');
...
<body onload="MM_preloadImages('images/fleet_active.gif','images/faq_active.gif','images/testimonials_active.gif','images/reserve_active.gif','images/contact_active.gif','images/home_active.gif')">
<div id="Wrapper"> 
 <!--Start Header Here -->
    	<div id="Header">
        ...
        <div id="Navigation">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><img src="images/rates_active.gif" width="93" height="33" /></td>
...
function updatepage(str){
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tbody>
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFCC">
                  ...
                  <table border="0" height="100" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <?php if (!empty($value['vehicle_image'])) { ?><img src="media/images/thumbs/<?php echo $value['vehicle_image']; ?>" alt="<?php echo $value['name']; ?>" title="<?php echo $value['name']; ?>" width="168" /><?php } ?>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                MM/DD/YYYY                				</td>
                        ...
                        <label><strong>Booster Seat</strong></label></td>
                            ...
                            <tr valign="middle">
                				<td height="10" colspan="2" align="center" class="ob style2">Note: For round trip  you can enter return date on next step</td>
                				<td width="7%" valign="top" class="ot">                             </td>
              				</tr>
                        </table>
                        </td>
              ...
              <div id="Notes" class="Notes"><?php echo $page_bottom2['page_content']; ?> </div>
          </td>
        </tr>
        <tr>
          <td class="footer">&nbsp;</td>
  ...
  <div>
    <?php echo $page_bottom['page_content']; ?>
    </div> 
  </div>

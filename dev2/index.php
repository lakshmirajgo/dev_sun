...
<link href="/includes/js/jquery-ui-1.10.2.custom/css/smoothness/jquery-ui-1.10.2.custom.css" rel="stylesheet">
...
<area shape="rect" coords="4,243,172,268" href="reserve.php" />
      ...
      <div id="b3" style="margin-bottom:3px;"><a href="reserve.php"><img src="../images/Image/B3.jpg" border="0" /></a> <br /><br />
        ...
        <div class="wXstickerbody" style="word-wrap:normal !important;width:180px;height:150px;border:1px #000 solid;background:url(http://img.weather.weatherbug.com/images/stickers/v2/180x150/bg.gif) no-repeat;">
           ...
           <div class="wXstickerforecast" style="margin-top:7px !important; margin-left:7px !important; z-index:-1;">
...
<br />
<div style="font-weight: bold; font-size: 16px; text-align:center;margin-top: -11px;"><img hspace="5" height="15" width="15" alt="" src="../images/Image/call.gif"> 407-601-7900</div>
<br />
           </div>
...
function updatepage(str){
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100%" valign="top"><form id="reserve" style="padding-top:0px;" name="reserve" method="post" action="https://dev.sunstatelimo.com/reserve_step2.php" onsubmit="return validate3(this)">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr valign="middle">
              ...
              <div id="Notes" class="Notes" align="center" style="padding-top:10px;"><span class="Notes" style="padding-top:10px;"><img src="images/convention.jpg" border="0" /></span>&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/Gola.gif" border="0" />&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/nlalogo.gif" border="0" /></div>          </td>
        </tr>
        <tr>
          <td class="footer">&nbsp;</td>
        </tr>

...
<title>Orlando's Airport Premier Transportation Services - Create a New Account</title>
...
<br />
<form style="padding-bottom:0px;" name="create_new" method="post" action="create_account.php<?php if (!empty($_GET['redirect'])) { echo "?redirect=".$_GET['redirect']; }; ?>" onsubmit="return validate2(this)" id="blinddown">

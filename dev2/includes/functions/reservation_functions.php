<?php
	...
	$add_reservations_sql = "INSERT INTO reservations (client_id, vehicle_id, location1_id, location2_id, travel_date, passenger_count, child_carseat, booster_seat, trip_type, pickup_at, arriving_airline, flight_number, arriving_at, travel_date_roundtrip, pickup_at_roundtrip, departing_airline_roundtrip, flight_number_roundtrip, departing_at, first_name, last_name, address, address2, city, state, zip, country, email, phone_number, cellphone, first_name_billing, last_name_billing, address_billing, address2_billing, city_billing, state_billing, zip_billing, country_billing, total_amount, card_number, card_type, exp_date, reservation_date, status, customer_comments, location1, location2, location3, pickup_at_extra, travel_date_extra, paying_cash, store_stop, ip_address) values('".$_SESSION['client_id']."', '".$_POST['vehicle_id']."', '".$_POST['from']."', '".$_POST['to']."', '".$travel_date."', '".$_POST['passenger_count']."', '".$child_carseat."', '".$child_boosterseat."', '".$_POST['trip_type']."', '".$pickup_at."', '".$_POST['arriving_airline']."', '".$_POST['flight_number']."', '".$arriving_at."', '".$travel_date_roundtrip."', '".$pickup_at_roundtrip."', '".$_POST['departing_airline_roundtrip']."',	'".$_POST['flight_number_roundtrip']."', '".$departing_at."', '"
        ...
        .mysql_real_escape_string($_POST['first_name_billing'])."', '"
        .mysql_real_escape_string($_POST['last_name_billing'])."', '"
        .mysql_real_escape_string($_POST['address_billing'])."','"
        .mysql_real_escape_string($_POST['address2_billing'])."','"
        .mysql_real_escape_string($_POST['city_billing'])."','"
        .mysql_real_escape_string($_POST['state_billing'])."', '"
        .mysql_real_escape_string($_POST['zip_billing'])."', '"
        .mysql_real_escape_string($_POST['country_billing'])."', '".$_POST['total_amount']."','".$cardnumber."', '".$_POST['card_type']."', '".$exp_date."', '$reservation_date', '".$status."', '".$_POST['customer_comments']."', '".$location1."', '".$location2."', '".$location3."', '$pickup_at_extra', '$travel_date_extra', '".$_POST['paying_cash']."', '".$_POST['store_stop']."', '".$ip."')";
                  ...
                  <?php 	
					...
					?>
                     ...
                     <td width="120" align="center" class="ot1"><?php echo format_to_caldate($value['reservation_date']); ?><br /><br /><?php if (!empty($value['total_amount'])) { echo "<strong><i>$".$value['total_amount']."</i></strong>"; }; ?></td>
                      ...
                      <td width="55" height="22" align="center"><a href="edit_reservation.php?cAction=edit&id=<?php echo $value['id']; ?>" class="bodytxt" title="Click to Edit"><!--<img src="images/edit.png" border="0" />-->Edit</a>&nbsp; | &nbsp;<a href="print_reservation.php?id=<?php echo $value['id']; ?>" class="bodytxt" title="Click to Print" target="_blank"><!--<img src="images/printmgr.png" border="0" />-->Print</a></td>
                      <td width="5"></td>
                    </tr>
                    <? 
					} 
	...
	//exit;
        ...
        .mysql_real_escape_string($_POST['country'])."', email='"
        .mysql_real_escape_string($_POST['email'])."', phone_number='"
        .mysql_real_escape_string($_POST['phone_number'])."', cellphone='"
        .mysql_real_escape_string($_POST['cellphone'])."', first_name_billing='"
        .mysql_real_escape_string($_POST['first_name_billing'])."', last_name_billing='"
        .mysql_real_escape_string($_POST['last_name_billing'])."', city_billing='"
        .mysql_real_escape_string($_POST['city_billing'])."', state_billing='"
        .mysql_real_escape_string($_POST['state_billing'])."', zip_billing='"
        .mysql_real_escape_string($_POST['zip_billing'])."', country_billing='"
        .mysql_real_escape_string($_POST['country_billing'])."', card_number='".$_POST['card_number']."', card_type='".$_POST['card_type']."', exp_date='".$exp_date."', customer_comments='"
        .mysql_real_escape_string($_POST['customer_comments'])."', paying_cash='".$_POST['paying_cash']."', store_stop='".$_POST['store_stop']."' where id='$id'";
	...
	global $db;
		$edit_cardholder_info_sql = "UPDATE reservations SET first_name_billing='".
            mysql_real_escape_string($_POST['first_name_billing'])."',last_name_billing='".
            mysql_real_escape_string($_POST['last_name_billing'])."', address_billing='".
            mysql_real_escape_string($_POST['address_billing'])."', address2_billing='".
            mysql_real_escape_string($_POST['address2_billing'])."', city_billing='".
            mysql_real_escape_string($_POST['city_billing'])."', state_billing='".
            mysql_real_escape_string($_POST['state_billing'])."', zip_billing='".
            mysql_real_escape_string($_POST['zip_billing'])."', country_billing='".
            mysql_real_escape_string($_POST['country_billing'])."' where id='$id'";
	...
	global $db;
		$edit_passenger_info_sql = "UPDATE reservations SET first_name='".
            mysql_real_escape_string($_POST['first_name'])."', last_name='".
            mysql_real_escape_string($_POST['last_name'])."', address='".
            mysql_real_escape_string($_POST['address'])."', address2='".
            mysql_real_escape_string($_POST['address2'])."', city='".
            ...
            mysql_real_escape_string($_POST['state'])."', zip='".
            mysql_real_escape_string($_POST['zip'])."', country='".
            mysql_real_escape_string($_POST['country'])."', phone_number='".
            mysql_real_escape_string($_POST['phone_number'])."', cellphone='".
            mysql_real_escape_string($_POST['cellphone'])."' where id='$id'";
	...
	global $db;
		$edit_reservation_info_sql = "UPDATE reservations SET customer_comments='".
            mysql_real_escape_string($_POST['customer_comments'])."' where id='$id'";

<?php
	...
	global $db;
		$edit_vehicles_sql = "UPDATE vehicles SET name='".mysql_real_escape_string($_POST['name'])."', description='".mysql_real_escape_string($_POST['description'])."', passengers='".$_POST['passengers']."' where id='$id'";
	...
	global $db; 
		$add_vehicles_sql = "INSERT INTO vehicles (name, description, passengers) values('".mysql_real_escape_string($_POST['name'])."', '".mysql_real_escape_string($_POST['description'])."', '".$_POST['passengers']."')";

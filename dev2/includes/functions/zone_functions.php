<?php
	...
	global $db;
		$edit_zones_sql = "UPDATE zones SET code='".$_POST['code']."', name='".mysql_real_escape_string($_POST['name'])."', description='".mysql_real_escape_string($_POST['description'])."' where id='$id'";
	...
	function add_zones(){
	global $db; 
		$add_zones_sql = "INSERT INTO zones (code, name, description) values('".$_POST['code']."', '".mysql_real_escape_string($_POST['name'])."', '".mysql_real_escape_string($_POST['description'])."')";

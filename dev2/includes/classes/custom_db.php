...
class db_class{
   ...
   function db_class() {
      ...
      $this->host = "localhost";
      $this->user = "sunstlim_dev";
      $this->pw = "GXkml.Gpe2KG";
      $this->db = "sunstlim_dev";
 ...
 function select($sql) {
   ...
   function select_one($sql) {
      ...
      mysql_free_result($r);
      if ($this->auto_slashes) stripslashes($ret);
      else return $ret;
   }
   
   function get_row($result, $type='MYSQL_ASSOC') {
   ...
   function dump_query($sql) {
      ...
      $r = $this->select($sql);
      if (!$r) return false;
      echo '<div style="border: 1px solid blue; font-family: sans-serif; margin: 8px;">n';
      echo '<table cellpadding="3" cellspacing="1" border="0" width="100%">n';
   ...
   function print_last_error($show_query=true) {
      ...
      // be displayed aswell.
 	$last_error = '<div style="border: 1px solid red; font-size: 9pt; font-family: monospace; color: red; padding: .5em; margin: 8px; background-color: #FFE2E2"><span style="font-weight: bold">Error:</span><br>'. $this->last_error .'</div>';
   ...
   function print_last_query() {
      ...
      $last_query = '
		  <div style="border: 1px solid blue; font-size: 9pt; font-family: monospace; color: blue; padding: .5em; margin: 8px; background-color: #E6E5FF">
			 <span style="font-weight: bold">Last SQL Query:</span>'. $this->last_query . '</div>';
	  echo $last_query;
   }
} 
?>

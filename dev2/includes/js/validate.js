...
function stripBlanks(fld) {var result = "", c = "";for (i=0; i<fld.length; i++) {
...
function validate3(form){
	if (!form.vehicle[0].checked && !form.vehicle[1].checked&& !form.vehicle[2].checked){
		alert("Please select a vehicle");
		form.vehicle[0].focus();
		return false;
	}
	...
	if(form.passenger_count.value=='' || !isNumeric(form.passenger_count.value)){
	...
	//Validate for Van
	if(vehiclechosen ==2 && form.passenger_count.value >10 )
	{
		alert('Sorry you can only have a maximum of 10 passengers in a Van.\nPlease enter 10 or less passengers');
		form.passenger_count.focus();
		return false;
	}
...
function validate5(form){
	...
	//Validate for Van
	if(vehiclechosen ==3 && form.passenger_count.value >10 )
	{
		alert('Sorry you can only have a maximum of 10 passengers in a Limousine.\nPlease enter 10 or less passengers');
		form.passenger_count.focus();
		return false;
	}
...
function validate4(form){
	...
	//alert('Now will run XML post AJAX');
	xmlhttpPost('calculate.php')
}

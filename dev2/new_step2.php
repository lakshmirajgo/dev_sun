...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="details"><?php echo $trip_details2;?></div>
	...
	<div class="user">	
		<div class="login gallery clearfix"><a href="#" rel="toggle[pane01]"></a></div>
		
		<!--login form-->
		 <div id="pane01">
		 	<div class="form">
				<form style="padding-bottom:0px;" name="login" method="post" action="new_step2.php" onsubmit="return validate(this)">
				<p><input name="email" type="text" value="Username" onfocus="clearText(this)" onblur="clearText(this)" required/></p>
				<p><input name="password" type="password" value="Password" onfocus="clearText(this)" onblur="clearText(this)" required/></p>
				<p><input name="logging_in" type="hidden" value="true"></p>
				<input type="image" src="images/login-btn-2.png">
		...
		<div class="passenger">
			...
			<div class="pass-mid">
				<form method="post" action="trans_details.php">
				<div class="pass-mid-inn">
				<h2>Passenger Information</h2>
				<div class="pass-left">
					<p>First Name</p>
					<p><input name="client_first_name" type="text" value=" <?php echo $_SESSION['client_first_name']; ?> "required/></p>
					<p>Address</p>
					<p><input name="client_address" type="text" value=" <?php echo $_SESSION['client_address']; ?> "required/></p>
					<p>Telephone</p>
					<p><input name="Telephone" type="text" value=" <?php echo $_SESSION['client_telephone']; ?> "required/></p>
					<?php if ($_SESSION['auth'] != '1') {echo "<p>Create Password</p><p><input name=\"\" type=\"text\" required/></p>";};?>
				</div>
				<div class="pass-right">
					<p>Last Name</p>
					<p><input name="client_last_name" type="text" value=" <?php echo $_SESSION['client_last_name']; ?> "/></p>
					...
					<p class="region">
						<span><input name="client_city" type="text" value=" <?php echo $_SESSION['client_city']; ?> " required/></span>
						<span><input name="client_state" type="text" value=" <?php echo $_SESSION['client_state']; ?> " required/></span>
						<span><input name="client_zip" type="text" value=" <?php echo $_SESSION['client_zip']; ?> "/ required></span>
					</p>
					<p>Email Address</p>
					<p><input name="client_email_address" value= "<?php echo $_SESSION['email']; ?>" type="text" /required></p>
					<?php if ($_SESSION['auth'] != '1') {echo "<p>Confirm Password</p><p><input name=\"\" type=\"text\" required/></p>";};?>
			...
			<div class="passenger">
						...
						<div class="trans-mid-inn">
							...
							<table>
								...
								<!--begin trip type dropdown-->
									<td>
										<p>Trip Type</p>
										<select id="Select1" name="trip_type" required="yes" size="1"  onchange="javascript:getNewContent(this.value)" >
									...
									<td>
										Date & Time<br>
										<input type="text" name="travel_date" id="basic_example_1" style="width: 140px;" value="<?php echo $_SESSION['travel_date']; ?>" />
				...
				<div class="pass-top">
					<div class="pmt-mid-inn">
						...
						<div class="pass-left">
							<p>First Name</p>
							<p><input name="billing_firstname" type="text" /></p>
							<p>Credit/Debit Card #</p>
							<p><input name="credit_crd" type="text" /></p>
							<p>Address</p>
							<p><input name="billing_address" type="text" /></p>
							<?php if ($_SESSION['auth'] != '1') {echo "<p>Create Password</p>";};?>
							<?php if ($_SESSION['auth'] != '1') {echo "<p>Create Password</p><p><input name=\"billing_password\" type=\"text\" /></p>";};?>
						</div>
						<div class="pass-right">
							<p>Last Name</p>
							<p><input name="billing_last_name" type="text" /></p>
							<p class="region">
								<span>Expiry Date </span>
								<span>CVV #</span>
							</p>
							<p class="region">
								<span><input name="cc_expiredate" type="text" /></span>
								<span><input name=""cww_number type="text" /></span>
							...
							<p class="region">
								<span><input name="billing_city" type="text" /></span>
								<span><input name="billing_state" type="text" /></span>
								<span><input name="billing_zip" type="text" /></span>
							</p>
						</div>
						<div>
							<h3>
		...
		<input name= "vehicle" type = "hidden" value = "<?php print ($_SESSION['vehicle']);?>")>
		<div align="center"><input name="confirm" type="image"  src="images/confirm-btn.png" width="228px" height="64px"/></div>
		</div>
</div>
</form>
